...
public class PackageAdapter extends FirebaseRecyclerAdapter<Details, PackageAdapter.myViewHolder> {
    ...
    public PackageAdapter(@NonNull FirebaseRecyclerOptions<Details> options) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow_package,parent,false);
...
public myViewHolder(@NonNull View itemView) {
    ...
    item17 = (TextView)itemView.findViewById(R.id.textView29);
            ...
            //pbdetails = (Button) itemView.findViewById(R.id.button8);
